# FGVC for pytorch1.6
The original beta version needs to install pytorch1.6 and pytorch0.4 separatly. I makes it work well with only pytorch1.6 installed.
...
- pip install scikit-image imageio ipdb opencv-python imageio-ffmpeg
- pip install addict cython mmcv numpy protobuf pillow opencv-python scipy six requests tensorboardx tqdm urllib3 terminaltables
